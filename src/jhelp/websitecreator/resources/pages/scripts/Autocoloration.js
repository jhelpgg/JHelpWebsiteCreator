...
var asmKeyWords = new Array("class","extends","field","field_reference","implements","import","method","parameter","return","throws");
...
function parseMarkupCode(makupCode, text, lang)
{
	...
	makupCode.innerHTML="<pre style=\"border:1px solid black;background: #F0F0FF;\"><font face=\"courier\" size=\"3\">"+text+"</font></pre>";
}
